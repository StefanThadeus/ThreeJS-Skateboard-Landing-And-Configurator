...
import { SkateboardModel } from "@/components/Models/Skateboard";
  ...
  return (
    <Canvas camera={{ position: [2.5, 1, 0], fov: 50 }} shadows>
      <Suspense fallback={null}>
        ...
        <group rotation={[0, 0, Math.PI / 2]} position={[0, 0.295, 0]}>
          <SkateboardModel
            deckVariant={selectedDeck}
...
function StageFloor() {
  const normalMap = useTexture("/concrete-normal.avif", (texture) => {
