...
export const SkaterScribble = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      className="origin-center opacity-60 transition-[stroke-dashoffset] duration-500 ease-in [stroke-dasharray:2400] [stroke-dashoffset:-2400] group-hover:[stroke-dashoffset:0] animate-squiggle"
      filter="url(#skater-scribble)"
      stroke="currentColor"
      strokeLinecap="round"
