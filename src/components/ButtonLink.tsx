  ...
  return (
    <Link
      className={clsx(
        ...
        size === "md" &&
          "gap-[clamp(0.75rem,3vw,0.75rem)] px-1 py-[clamp(0.625rem,3vw,0.75rem)] text-lg",
        size === "lg" &&
          "text-[clamp(1.125rem,2.5vw+0.25rem,1.5rem)] gap-[clamp(0.75rem,4vw,1rem)] px-[clamp(0.25rem,3vw,0.5rem)] py-[clamp(0.75rem,4vw,1rem)]",
        color === "orange" &&
        ...
        <>
          <div
            className={clsx(
              ...
              size === "sm" && "size-5",
              size === "md" && "size-6",
              size === "lg" && "size-[clamp(1.5rem,4vw,2rem)]",
            )}
          >
